...
import com.mdove.civilservantcommunity.view.timelineitemdecoration.itemdecoration.DotItemDecoration;
import com.mdove.civilservantcommunity.view.timelineitemdecoration.itemdecoration.SpanIndexListener;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mItemDecoration.setSpanIndexListener(new SpanIndexListener() {
            ...
            public void onSpanIndexChange(View view, int spanIndex) {
                ...
                view.setBackgroundResource(spanIndex == 0 ? R.drawable.bg_hot_article_top1_stub_ : R.drawable.bg_hot_article_top2_stub_);
            }
        });
