...
import com.mdove.dependent.common.view.calendar.listener.OnEndAnimatorListener;
import com.mdove.dependent.common.view.calendar.listener.OnMWDateChangeListener;
import com.mdove.dependent.common.view.calendar.painter.CalendarAdapter;
import com.mdove.dependent.common.view.calendar.painter.CalendarPainter;
import com.mdove.dependent.common.view.calendar.painter.InnerPainter;
import com.mdove.dependent.common.view.calendar.utils.Attrs;
import com.mdove.dependent.common.view.calendar.utils.AttrsUtil;
import com.mdove.dependent.common.view.calendar.utils.ViewUtil;
...
public abstract class NCalendar extends FrameLayout implements IICalendar, NestedScrollingParent, ValueAnimator.AnimatorUpdateListener {
    ...
    public NCalendar(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        setCalendarPainter(new InnerPainter(this, null));
