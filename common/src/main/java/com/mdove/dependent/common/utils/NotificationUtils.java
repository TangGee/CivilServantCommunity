...
import com.mdove.dependent.common.BaseApplication;
...
public class NotificationUtils {
    ...
    public static boolean areNotificationsEnabled() {
        return NotificationManagerCompat.from(BaseApplication.getInst()).areNotificationsEnabled();
    }
    ...
    public static void notify(String tag, int id, ChannelConfig channelConfig, Func1<Void, NotificationCompat.Builder> func1) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            NotificationManager nm = (NotificationManager) BaseApplication.getInst().getSystemService(Context.NOTIFICATION_SERVICE);
            nm.createNotificationChannel(channelConfig.getNotificationChannel());
        }

        NotificationManagerCompat nmc = NotificationManagerCompat.from(BaseApplication.getInst());

        NotificationCompat.Builder builder = new NotificationCompat.Builder(BaseApplication.getInst());
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
    ...
    public static void cancel(String tag, final int id) {
        NotificationManagerCompat.from(BaseApplication.getInst()).cancel(tag, id);
    }
    ...
    public static void cancel(final int id) {
        NotificationManagerCompat.from(BaseApplication.getInst()).cancel(id);
    }
    ...
    public static void cancelAll() {
        NotificationManagerCompat.from(BaseApplication.getInst()).cancelAll();
    }
    ...
    private static void invokePanels(final String methodName) {
        try {
            ...
            Object service = BaseApplication.getInst().getSystemService("statusbar");
    ...
    public static class ChannelConfig {
        ...
        public static final ChannelConfig DEFAULT_CHANNEL_CONFIG = new ChannelConfig(
                BaseApplication.getInst().getPackageName(), BaseApplication.getInst().getPackageName(), IMPORTANCE_DEFAULT
        );
